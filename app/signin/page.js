...
export default function Signin() {
  ...
  const onSubmit = async (data) => {
    console.log("[Signin] Form submission initiated:", { email: data.email });
    try {
      ...
      console.error("[Signin] Login attempt failed:", {
  ...
  return (
    <div className="flex flex-col lg:flex-row min-h-screen w-full overflow-y-auto transition-colors duration-500">
      ...
      <div className="w-full lg:w-1/2 min-h-screen flex items-center justify-center p-6 lg:p-12 relative pt-16 pb-12 lg:py-0">
            ...
            <div className="space-y-1">
              ...
              <div className="flex justify-end pt-1">
                <Link
                  ...
                  size="sm"
                  className="text-[11px] font-bold text-[#00B4EB] hover:text-[#009bc9] transition-colors uppercase tracking-widest"
                >
                  Forgot Password?
                </Link>
              </div>
        ...
        <div className="absolute bottom-12 left-12 right-12 z-20 transition-transform duration-700 ease-out group-hover:-translate-y-3">
          ...
          >
            ...
            <p className="text-slate-300 text-lg max-w-md leading-relaxed">
              Access the most advanced corporate finance management suite.
              Secure, unified, and enterprise-ready.
            </p>
          </motion.div>
        </div>
      </div>
