...
export default function Signup() {
  ...
  return (
    <div className="flex flex-col lg:flex-row min-h-screen w-full bg-white dark:bg-[#020617] overflow-hidden transition-colors duration-500">
        {/* Navigation Logo */}
            ...
            <div className="absolute bottom-12 left-12 right-12 z-20 transition-transform duration-700 ease-out group-hover:-translate-y-3">
                ...
                >
                    ...
                    <p className="text-slate-300 text-lg max-w-md leading-relaxed">
                        The future of corporate financial management is here. Simple, powerful, and built for enterprise success.
                    </p>
                </motion.div>
            </div>
        </div>
        ...
        <div className="w-full lg:w-1/2 min-h-screen flex items-center justify-center p-6 lg:p-12 relative overflow-y-auto">
             ...
             <motion.div 
                ...
                className="w-full max-w-[480px] relative z-20 py-12 lg:py-0"
             >
                <div className="mb-8 text-left">
                    <h1 className="text-3xl font-bold text-slate-900 dark:text-white tracking-tight mb-2">Create Account</h1>
                    <p className="text-slate-500 dark:text-slate-400 text-sm">Empower your business with SLT Digital services</p>
                </div>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div className="space-y-1">
                            <InputField label="Confirm" icon={ShieldCheck} type="password" placeholder="••••••••" {...register('password_confirmation')} error={errors.password_confirmation?.message} />
                        </div>
                    </div>
                    ...
                    <p className="text-left text-[11px] text-slate-500 mt-4 leading-relaxed">
                        By signing up, you agree to our <a href="#" className="font-bold text-[#00B4EB] hover:underline">Terms of Service</a> and <a href="#" className="font-bold text-[#00B4EB] hover:underline">Privacy Policy</a>.
                    </p>

                    <div className="mt-8 pt-6 border-t border-slate-100 dark:border-slate-800 text-left">
                         <p className="text-slate-500 dark:text-slate-400 text-sm">
                            Already have an account?{' '}
                            <Link href="/signin" className="text-[#008001] font-bold hover:text-[#00B4EB] transition-colors uppercase text-xs tracking-widest ml-1">
                                Sign In
                            </Link>
                        </p>
                    </div>
